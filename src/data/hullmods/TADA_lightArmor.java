...
public class TADA_lightArmor extends BaseHullMod {

    private final Map<ShipAPI.HullSize, Float> shipSpeed = new HashMap<>();
    {
        shipSpeed.put(ShipAPI.HullSize.DEFAULT, 10f);
        shipSpeed.put(ShipAPI.HullSize.CAPITAL_SHIP, 20f);
    ...
    {
        shipEngines.put(ShipAPI.HullSize.DEFAULT, 15f);
...
//        }
        ...
        String list = "\n";
        for(String id : LighPlating_noncompatible){
